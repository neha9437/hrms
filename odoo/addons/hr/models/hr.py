...
class Employee(models.Model):
    ...
    work_phone = fields.Char('Alternate Phone')
    ...
    def _onchange_department(self):
        ...
        self.hr_executive_id = self.department_id.hr_executive_id
...
class Department(models.Model):
    ...
    def write(self, vals):
        ...
        if 'hr_executive_id' in vals:
            hr_executive_id = vals.get("hr_executive_id")
            department_id = self.id
            print(hr_executive_id,department_id)
            # nn
            self.env.cr.execute('UPDATE hr_employee set hr_executive_id = %s where department_id = %s'% (hr_executive_id,department_id))
            self.env.cr.commit()
